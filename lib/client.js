window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    // ============================================================
    // dsh-todo-float-ball — client half (browser).  v0.9.1
    //
    ...
    function renderList() {
      ...
      if (ui.ctitle) {
        ...
        if (editing.sid === normSid(currentSid)) { /* keep editor */ }
          ...
          ui.ctitle.textContent = currentSid ? sessionTitle(currentSid) : ""; if (ui.capCur) ui.capCur.textContent = "▸ " + (ui.ctitle.textContent || "当前对话");
    ...
    function buildUI() {
      ...
      ui.pinSec = root.querySelector(".tfb-pinsec"); ui.capCur = root.querySelector('[data-cap="cur"]');
      ...
      root.addEventListener("click", function (e) {
        ...
        if (act === "close") hide();
          ...
          e.stopPropagation();          var li = t.closest ? t.closest(".tfb-item") : null;
    ...
    function watchBallVisibility() {
      ...
      setInterval(function () {
        ...
        try {
          ...
          if (isTheme(v) && v !== currentTheme) applyThemeNow();
        } catch (e) {}
      }, 2000);
    }
